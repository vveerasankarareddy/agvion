          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
                <Button
                  className="btn-primary px-8 py-4 text-lg rounded-xl font-medium"
                ...
                <Button className="btn-secondary px-8 py-4 text-lg rounded-xl font-medium">
            ...
            >
              <div className="clean-card rounded-2xl overflow-hidden">
                <div className="aspect-[16/9] bg-gray-50 relative">
                  {/* Browser Header */}
                  <div className="absolute top-0 left-0 right-0 h-12 bg-gray-100 flex items-center px-4 border-b border-gray-200 z-10">
                  ...
                  <div className="absolute top-12 left-0 right-0 bottom-0">
                    <img 
                      ...
                      alt="AGVION Studio Workflow Interface"
